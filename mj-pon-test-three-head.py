...
def directly_draw():
    ...
    while(1):
        ...
        #print("draw =",draw)
        method1_count += 1
        if(draw == 3 or draw ==6 or draw == 7):
            break
        elif(draw == 4 or draw == 5 or draw == 8 or draw == 9 or draw == 10):
            #2.5 pairs
            if(method1_key == 0):
                method1_key = draw
                card_pool.pop(0)
            #judge if bingo
                ...
                elif(method1_key == 10 and (draw == 4 or draw ==5 or draw == 8 or draw
                    == 9)):
                    break
                else:
                    card_pool.pop(0)
...
def pon_then_draw():
    ...
    while(1):
        ...
        #print("draw =",draw)
        method2_count += 1
        if(draw == 3 or draw == 4 or draw == 5 or draw == 6 or draw == 7 or draw == 8 or draw == 9):
            break
        else:
            card_pool.pop(0)
    #print("method2 count =",method2_count+1)
